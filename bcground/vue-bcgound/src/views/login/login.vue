  ...
  <div id="login" ref='vantaRef' style="width: 100%;height: 100vh">
    ...
    <el-dialog v-model="data.dialogTableVisible" title="人机验证" width="450">
        <div style="display: flex;justify-content: center;align-items: center">
          <SliderVerify
              :imgUrl="data.sliderVConf.imgUrl"
              :sText="data.sliderVConf.sText"
              :eText="data.sliderVConf.eText"
              v-model:isShowSelf="data.sliderVConf.isShowSelf"
              :isBorder="data.sliderVConf.isBorder"
              :isParentNode="data.sliderVConf.isParentNode"
              :isCloseBtn="data.sliderVConf.isCloseBtn"
              :isReloadBtn="data.sliderVConf.isReloadBtn"
              :width="data.sliderVConf.width"
              :height="data.sliderVConf.height"
